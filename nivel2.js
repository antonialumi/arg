...
let comidasFavoritas = ["pasta", "milanesas de berenjena", "nuggets", "papas de cualquier forma"];
...
const piedrasPreciosas = ["amatista", "pirita","jade", "turmalina"];
piedrasPreciosas.push("obsidiana");
piedrasPreciosas[1] = "opalo";
console.log(piedrasPreciosas);
...
/*
piedrasPreciosas = ["cuarzo","lapislazuli"];
console.log(piedrasPreciosas);
*/
